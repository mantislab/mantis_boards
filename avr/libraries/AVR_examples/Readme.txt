...
If you're using Arduino IDE 1.6.5 or lower, you'll have to select a MantisCore compatible microcontroller and restart the IDE in order to highlight the keywords.
